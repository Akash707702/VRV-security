...
import { FaEdit, FaTrash, FaPlusCircle } from "react-icons/fa"; // Importing icons
      ...
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            {/* Replaced logo with bold text */}
            <h2 className="text-3xl font-bold text-gray-700 mr-4">Akash Mohanty pvt. ltd</h2>
          </div>
          <button
            className="bg-blue-500 text-white font-semibold px-5 py-2 rounded-full shadow-lg hover:bg-blue-600 transition duration-300 flex items-center"
